...
CREATE  TABLE IF NOT EXISTS `mydb`.`Servico` (
  ...
  CONSTRAINT `fk_Servico_Familia1`
    ...
    REFERENCES `mydb`.`Familia` (`id` , `Cla_id` , `Categoria_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
CREATE  TABLE IF NOT EXISTS `mydb`.`Recurso` (
  ...
  CONSTRAINT `fk_Recurso_Tipo_Recurso1`
    ...
    REFERENCES `mydb`.`Tipo_Recurso` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Recurso_Tipo_Unidade1`
    FOREIGN KEY (`Tipo_Unidade_id` )
    REFERENCES `mydb`.`Tipo_Unidade` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1
...
CREATE  TABLE IF NOT EXISTS `mydb`.`Servico_has_Servico` (
...
CREATE  TABLE IF NOT EXISTS `mydb`.`Composicao` (
  `servico_id` INT(11) NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `mydb`.`Tipo_Unidade` (
  `id` INT(11) NOT NULL ,
  `descricao` VARCHAR(45) NULL DEFAULT NULL ,
  `cadastro` TIMESTAMP NULL DEFAULT NULL ,
  PRIMARY KEY (`id`) )
...
CREATE  TABLE IF NOT EXISTS `mydb`.`Categoria_Servico` (
  `id` INT(11) NOT NULL ,
  `descricao` VARCHAR(45) NULL DEFAULT NULL ,
  `cadastro` TIMESTAMP NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `mydb`.`Cla` (
  `id` INT(11) NOT NULL ,
  `categoria_id` INT(11) NOT NULL ,
  `descricao` VARCHAR(45) NULL DEFAULT NULL ,
  `sigla` CHAR(2) NULL DEFAULT NULL ,
  ...
  CONSTRAINT `fk_Cla_Servico_Categoria_Servico1`
    ...
    REFERENCES `mydb`.`Categoria_Servico` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1
...
CREATE  TABLE IF NOT EXISTS `mydb`.`Familia` (
  ...
  CONSTRAINT `fk_Familia_Cla_Servico1`
    ...
    REFERENCES `mydb`.`Cla` (`id` , `categoria_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1
